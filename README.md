...
In the project directory, you can run using npm (installing necessary dependencies) or using Docker.

### `npm run start` or `docker compose up frontend`
...
### `npm run test` or `docker compose up test`
